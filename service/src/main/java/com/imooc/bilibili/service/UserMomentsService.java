...
public class UserMomentsService {
    ...
    //applicationContext to get Bean
    @Autowired
    ...
    public void addUserMoments(UserMoment userMoment) throws Exception{
        ...
        Message msg = new Message(UserMomentConstant.TOPIC_MOMENT, JSONObject.toJSONString(userMoment).getBytes(StandardCharsets.UTF_8));
